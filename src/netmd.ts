...
export const DevicesIds = [
    ...
    { vendorId: 0x054c, deviceId: 0x018a, name: 'Sony LAM-X1/NetMD' }, //The
    { vendorId: 0x054c, deviceId: 0x018c, name: 'Sony LAM-X1' }, //The
    ...
    { vendorId: 0x054c, deviceId: 0x018b, name: 'Sony LAM-3' },
